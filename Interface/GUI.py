...
class GUI(tk.Tk):
    ...
    def __init__(self):
        if GUI.__instance != None:
         ...
         self.resizable(0,0)
         self.var=tk.IntVar()
         self.iconbitmap(r'Interface\CV_Hunter_MaroonBG.ico')
...
class ScanningGUI(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        BackgroungImage = ImageTk.PhotoImage(file="Interface\CTA_scan_your_resume-03-02.png")
    ...
    def resize_image(self,event):
        ...
        image3=Image.open('Interface\CTA_scan_your_resume-03-02.png')
...
class CVsView(tk.Frame):
    ...
    def DrawWindow(self,ResumeList):
       ...
       self.treeview.bind("<Double-1>",OnDoubleClick)
